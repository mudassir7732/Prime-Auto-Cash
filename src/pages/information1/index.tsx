...
const USER_SCHEMA = yup.object().shape({
    full_name: yup.string().required('Year required'),
    email: yup.string().required('Transmission required'),
    mobile_no: yup.number().typeError('Numbers only').required('VIN required'),
})
